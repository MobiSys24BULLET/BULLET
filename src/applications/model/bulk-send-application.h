...
class BulkSendApplication : public Application
{
  public:
    ...
    typedef void (*TracedCallback)(Ptr<const BulkSendApplication> bulkSender);
  ...
  private:
    ...
    /// and header
    ns3::TracedCallback<Ptr<const Packet>, const Address&, const Address&, const SeqTsSizeHeader&>
