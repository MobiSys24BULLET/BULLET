 ...
 * of RtsServerTxBuffer. Each instance keeps track of the object type to be
 ...
 */
class RtsServer : public Application
{
  public:
    /**
     ...
     * \param httpServer Pointer to this instance of RtsServer, which is where
     *                   the trace originated.
     * \param socket Pointer to the socket where the connection is established.
     */
    typedef void (*ConnectionEstablishedCallback)(Ptr<const RtsServer> httpServer,
                                                  Ptr<Socket> socket);
  ...
  private:
    ...
    Ptr<RtsServerTxBuffer> m_txBuffer;
    ...
    TracedCallback<Ptr<const RtsServer>, Ptr<Socket>> m_connectionEstablishedTrace;
 ...
 * be added.
 */
class RtsServerTxBuffer : public SimpleRefCount<RtsServerTxBuffer>
{
  public:
...
}; // end of `class RtsServerTxBuffer`
