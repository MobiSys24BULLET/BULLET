...
class LtePdcp : public Object // SimpleRefCount<LtePdcp>
{
  ...
  public:
    ...
    typedef void (*AppTracedCallback)(int frameNum,
                                      int sequence,
                                      int frameSize);


    typedef void (*DlTracedCallback)(Ipv4Header& ipheader,
                                          TcpHeader& tcpheader);
  ...
  protected:
    ...
    TracedCallback<int, int, int> m_appTrace;

    TracedCallback<Ipv4Header &, TcpHeader &> m_dlTrace;
