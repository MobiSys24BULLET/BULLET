...
class NrMacSchedulerTdma : public NrMacSchedulerNs3
{
  public:
    ...
    mutable std::map <uint16_t, uint32_t> m_proactiveBSR;
  ...
  protected:
    ...
    // BULLET
    void SetProactiveBSR(std::map <uint16_t, ns3::Ptr<BulletTrigger>>) const override;
    ...
    virtual void AssignedUlResourcesPro(const UePtrAndBufferReq& ue,
                             const FTResources& assigned,
                             const FTResources& totAssigned) const  = 0;
    ...
    virtual void NotAssignedUlResourcesPro(const UePtrAndBufferReq& ue,
                             const FTResources& assigned,
                             const FTResources& totAssigned) const  = 0;
