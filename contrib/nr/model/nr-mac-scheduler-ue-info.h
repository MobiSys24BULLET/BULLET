...
class NrMacSchedulerUeInfo
{
  public:
    ...
    virtual void UpdateUlMetricPro(const Ptr<const NrAmc>& amc);
    ...
    uint32_t m_ulRBGPro{0}; //!< UL Resource Block Group assigned in this slot
