...
std::function<bool(const NrMacSchedulerNs3::UePtrAndBufferReq& lhs,
                   const NrMacSchedulerNs3::UePtrAndBufferReq& rhs)>
NrMacSchedulerOfdmaPF::GetUeCompareUlFnPro() const
{
    return NrMacSchedulerUeInfoPF::CompareUeWeightsUlPro;
}
...
void 
NrMacSchedulerOfdmaPF::AssignedUlResourcesPro(const UePtrAndBufferReq& ue,
...
void 
NrMacSchedulerOfdmaPF::NotAssignedUlResourcesPro(const UePtrAndBufferReq& ue,
                             const FTResources& assigned,
                             const FTResources& totAssigned) const
{
    NS_LOG_FUNCTION(this);
