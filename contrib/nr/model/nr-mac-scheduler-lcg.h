...
class NrMacSchedulerLC
{
  public:
    ...
    uint32_t GetReactiveTotalSize () const;
    ...
    uint32_t m_proactiveQueueSize{0};
};
...
class NrMacSchedulerLCG
{
  public:
    ...
    // BULLET
    void UpdateProactiveBSR (uint32_t proactiveBSR);
    ...
    // For BULLET private --> public
    uint8_t m_id{0};    

  private:                        //!< ID of the LCG
