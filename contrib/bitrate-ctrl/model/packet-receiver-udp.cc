...
void PacketReceiverUdp::Feedback_NetState ()
{
    ...
    NS_LOG_UNCOND(" LossRate" << this->loss_rate << " Throughput" << this->throughput_kbps << " FEC group delay" << this->one_way_dispersion.GetMicroSeconds());
